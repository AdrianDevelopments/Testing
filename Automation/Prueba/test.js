...
const CountTime = async () => {
    try {
        console.log("AVISO: La version 1 de este programa solo acepta encuestas en Google Forms de 20 preguntas y 5 opciones")
        console.log(" ")
        const response = readline.question("Porfavor, introduce un link válido a una encuesta de Google Forms: ")
        ...
        console.error("Error: El link que ha introducido NO es válido. Reiniciando programa....")
        CountTime()
    }
